...
{
	// 创建消费者
	int nRet = SafeCreateC( MQ_BMC_NTF_Q, MQ_BMC_NTF_EX, NULL, Content_MQCB, NULL, NULL, Consumer_ConSuc_MQCB, Consumer_ConFail_MQCB,
...
=============================================================================*/
void CBmcSsnData::Consumer_ConSuc_MQCB( amqp_connection_state_t conn, char *desc, char* pchTag )
{	
	g_cMauVCApp.GetMqStatus().SetMau_NotifyIsCreated(TRUE);
	...
	LogPrint( LOG_LVL_KEYSTATUS, MID_MAU_BMC, "[CBmcSsnData::Consumer_ConSuc_MQCB]%s.\n", achSucDec );	
    return;
}
...
2015/03/09  5.0         rnn                   创建
=============================================================================*/
void CBmcSsnData::Consumer_ConFail_MQCB( amqp_connection_state_t conn, const char *expect,
	const char *precv, char* pchTag )
{	
	g_cMauVCApp.GetMqStatus().SetMau_NotifyIsCreated(FALSE);
	...
	LogPrint( LOG_LVL_ERROR, MID_MAU_BMC, "[CBmcSsnData::Consumer_ConFail_MQCB]expect.%s.\n", achExpect );
	LogPrint( LOG_LVL_ERROR, MID_MAU_BMC, "[CBmcSsnData::Consumer_ConFail_MQCB]precv.%s.\n", achRecv );
}
