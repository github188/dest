...
### ReVision History:
###
### 2007/08/23 GuZhenhua： add macros for different hardware archit
...
# for 64bit compiler compile 32bit program
CFLAGS += -m32 
LDFLAGS += -m32
...
#增加对cc后缀名的支持(针对protobuf产生的文件和路径)
