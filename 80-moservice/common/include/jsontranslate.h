...
#define JSON_CREATORACCOUNT     "creatoraccount"
#define JSON_CREATORACCOUNTTYPE "creatoraccounttype" //创会者账户类型
#define JSON_CREATORTELEPHONE   "creatortelephone"   //创会者座机
#define JSON_CREATORMOBILE      "creatormobile"      //创会者手机
...
#define JSON_ENCRYPTMODE       "encryptmode"       //码流加密模式：2-AES，0-不加密,3-SM4，4-SM1
#define JSON_ENCRYPTAUTH       "encryptauth"       //国密加密模式下，终端双向认证
...
#define JSON_USEMEDIASOURCE    "usemediasource"         //使用媒体资源

#define JSON_MAXJOINEDMT	   "maxjoinedmt"		  //最大入会终端数量
#define JSON_PREAPPLYMS  	   "preoccupy"		  //是否预占媒体资源
...
#define JSON_INVITEMODE		   "invitemode"		  //邀请方式 ADDMTMODE_MCS\ADDMTMODE_CHAIRMAN\ADDMTMODE_MTSELF
...
#define JSON_PACKETLOSSRATE	   "packetlossrate"	 //终端丢包率
...
#define JSON_FORCECALL         "forcecall"          //是否强拆
#define JSON_CONFLEVEL        "conflevel"          //会议等级
#define JSON_ISSUPPORTSELFVMP    "issupportselfvmp"    //是否支持自主多画面
...
#define JSON_CHAIRMANPOLL      "chairmanpoll"		//主席轮询参数
...
#define JSON_HDUCHNSTATUS		"chnstatus"			//电视墙通道状态， 0=可用状态  1=已被其他终端占用  255=无效状态	
...
//暂时不支持hdu模板单通道轮询
#define JSON_HDUPOLL			"hdupoll"			//通道轮询
// #define JSON_HDUPOLLNUM			"pollnum"			//轮询次数，0为一直轮询
// #define JSON_HDUPOLLTIME		"keeptime"			//轮询时间间隔，  10s
// #define JSON_HDUPOLLMODE		"pollmode"			//轮询模式
...
#define JSON_HDU_BATCHPOLL		"batchpoll"

#define JSON_REC_MODE			"recmode"			 //模式，1=录像 2=直播 3=both
#define JSON_PUBLISH_MODE       "publishmode"        //发布模式
#define JSON_ISANONYMOUS        "isanonymous"        //是否勾选免登陆观看直播
...
#define JSON_PLAYATTRB			"playattrb"			//放像参数
#define JSON_VRSID              "vrsid"             //放像id
...
#define JSON_MTCAMERAVCL_INFO   "vchlinfo"           ////通道预置位信息
#define JSON_MTCAMERPOLL_INFO   "posinfo"

#define JSON_MTVIDSRC_INFO      "vidsrcinfo"			//  [5/02/2017 xiayu]终端所有视频源信息
#define JSON_TAGIVIDEOSOURCEINFO  "tagivideosource"				//  [5/02/2017 xiayu]对应每个通道的视频源信息
#define JSON_VIDSRC_INDEX		"vidsrcidx"				//  [5/02/2017 xiayu]终端 视频源编号
#define JSON_VIDSRC_NAME		"vidsrcname"			//  [5/02/2017 xiayu]终端 视频源名称
...
#define JSON_DSTVIDCAP			"dstvidcap"		    //视频目的接收能力
...
#define JSON_AUDIOSAMPLEFREQ	"audiosamplefreq"		//采样率
#define JSON_AUDIOCHNLNUM		"audiochnlnum"		//音轨数量
...
//获取会议列表
#define EV_MAU_MCU_GETCONFLIST_CMD					"MAU_MCU_GETCONFLIST_CMD"
//CMU保活通知
...
// 添加终端失败通知
#define EV_CMU_CM_ADDMT_FAIL_NTF						"CMU_CM_ADDMT_FAIL_NTF"
...
// 会管开始mixer监控
#define EV_CM_CMU_STARTMONITORING_MIXER_REQ			"CM_CMU_STARTMONITORING_MIXER_REQ"
#define EV_CMU_CM_STARTMONITORING_MIXER_ACK			"CMU_CM_STARTMONITORING_MIXER_ACK"
#define EV_CMU_CM_STARTMONITORING_MIXER_NACK		"CMU_CM_STARTMONITORING_MIXER_NACK"

// 会管开始监控vmp
#define EV_CM_CMU_STARTMONITORING_VMP_REQ			"CM_CMU_STARTMONITORING_VMP_REQ"
#define EV_CMU_CM_STARTMONITORING_VMP_ACK			"CMU_CM_STARTMONITORING_VMP_ACK"
#define EV_CMU_CM_STARTMONITORING_VMP_NACK			"CMU_CM_STARTMONITORING_VMP_NACK"
...
#define EV_CMU_CM_STARTMONITORINGFAIL_NTF			"CMU_CM_STARTMONITORINGFAIL_NTF"
#define EV_CMU_CM_STARTMONITORINGALARM_NTF			"CMU_CM_STARTMONITORINGALARM_NTF"
// 会议停止监控通知
...
//获取终端终端实时信息
#define EV_CM_CMU_GETREALTIMEMTSTATUS_CMD             "CM_CMU_GETREALTIMEMTSTATUS_CMD"
#define EV_CMU_CM_GETREALTIMEMTSTATUS_NTF             "CMU_CM_GETREALTIMEMTSTATUS_NTF"

//  [5/2/2017 xiayu] 会馆指定终端视频源
#define EV_CM_CMU_GETMTVIDEOSOURCEINFO_CMD             "CM_CMU_GETMTVIDEOSOURCEINFO_CMD"
#define EV_CM_CMU_SETMTVIDEOSOURCE_CMD					"CM_CMU_SETMTVIDEOSOURCE_CMD"
#define EV_CMU_CM_MTALLVIDEOSOURCEINFO_NTF				"CMU_CM_MTALLVIDEOSOURCEINFO_NTF"
...
//主席选看非广播的画面合成
#define EV_CM_CMU_STARTSEEVMP_REQ                    "CM_CMU_STARTSEEVMP_REQ"
#define EV_CMU_CM_STARTSEEVMP_ACK                    "CMU_CM_STARTSEEVMP_ACK"
#define EV_CMU_CM_STARTSEEVMP_NACK                   "CMU_CM_STARTSEEVMP_NACK"


//停主席选看非广播画面合成
#define EV_CM_CMU_STOPSEEVMP_REQ                      "CM_CMU_STOPSEEVMP_REQ"
#define EV_CMU_CM_STOPSEEVMP_ACK                      "CMU_CM_STOPSEEVMP_ACK"
#define EV_CMU_CM_STOPSEEVMP_NACK                     "CMU_CM_STOPSEEVMP_NACK"

//MAU命令MCU更新会议所有信息到redis
#define EV_MAU_MCU_UPDATEALLCONFDATA_CMD            "MAU_MCU_UPDATEALLCONFDATA_CMD"

//暂时API不支持同等级会议上报是否允许强拆交互
// 强拆请求
// #define EV_CMU_CM_RELEASEMT_REQ                     "CMU_CM_RELEASEMT_REQ"
// #define EV_CM_CMU_RELEASEMT_ACK                     "CM_CMU_RELEASEMT_ACK"
// #define EV_CM_CMU_RELEASEMT_NACK                     "CM_CMU_RELEASEMT_NACK"
...
static BOOL32 __GetStringAsBoolFromJson(const json_t_ptr& pjObj, const s8* abyName, BOOL32 &bValue, const s8* abyFuncName)
{
	const s8* pchString = NULL;
	if (__GetStringFromJson(pjObj, abyName, &pchString, abyFuncName))
	{
		u32 dwValue = strtoul(pchString, 0, 10);
		bValue = (dwValue == 0 ? FALSE : TRUE);
		return TRUE;
	}
	return FALSE;
}
...
static BOOL32 __LoadJson(const s8 * pchJsonBuf, u32 dwJsonBufLen, json_t_ptr& pjRoot, BOOL32 bCreateIfNull, const s8* abyFuncName)
{
	if (NULL == pchJsonBuf)
	{
		OspPrintf(TRUE, FALSE, "[%s] Param is NULL, return!\n", abyFuncName);
		return FALSE;
	}
...
static BOOL32 __DumpJson(const json_t_ptr pjRoot, s8 * pchJsonBuf, u32 dwMaxLen, u32& dwRealLen, const s8* abyFuncName)
{
	...
	u32 dwStrLen = strlen(pchData);
	if (dwMaxLen < dwStrLen)
	{
...
#define GetStringAsBoolFromJson(root, name, value) __GetStringAsBoolFromJson(root, name, value, __FUNCTION__)

#define GetIntFromJson(root, name, value) __GetIntFromJson(root, name, value, __FUNCTION__)


#define GetConfE164FromJsonObj(pjObj, pchConfE164) GetStringFromJson(pjObj, JSON_CONFE164, pchConfE164)
#define GetConfNameFromJsonObj(pjObj, pchConfName) GetStringFromJson(pjObj, JSON_CONFNAME, pchConfName)
#define GetConfPasswordFromJsonObj(pjObj, pchConfPassword) GetStringFromJson(pjObj, JSON_PSW, pchConfPassword)

#define GetSpeakerAliasFromJsonObj(pjObj, pchSpeaker) GetStringFromJson(pjObj, JSON_SPEAKERALIAS, pchSpeaker)
#define SetSpeakerAliasToJsonObj(pjObj, tSpeaker) SetStringToJson(pjObj, JSON_SPEAKERALIAS, tSpeaker.m_achAlias)

#define GetChairAliasFromJsonObj(pjObj, pchChairMan) GetStringFromJson(pjObj, JSON_CHAIRMANALIAS, pchChairMan)
#define SetChairAliasToJsonObj(pjObj, tChair) SetStringToJson(pjObj, JSON_CHAIRMANALIAS, tChair.m_achAlias)

#define SetCreatorNameToJsonObj(pjObj, pchCreator) SetStringToJson(pjObj, JSON_CREATORNAME, pchCreator)
#define SetCreatorMoidToJsonObj(pjObj, pchCreatorMoid) SetStringToJson(pjObj, JSON_CREATORMOID, pchCreatorMoid)

#define GetConfMaxJoinedMtNumFromJsonObj(pjObj, mtNum) GetStringAsUIntFromJson(pjObj, JSON_MAXJOINEDMT, mtNum)
...
#define GetDomainMoidFromJsonObj(pjObj, pchDomainMoid) GetStringFromJson(pjObj, JSON_MOID, pchDomainMoid)
#define SetDomainMoidToJsonObj(pjObj, pchDomainMoid) SetStringToJson(pjObj, JSON_MOID, pchDomainMoid)

#define SetDomainNameToJsonObj(pjObj, pchDomainName) SetStringToJson(pjObj, JSON_DOMAINNAME, pchDomainName)

#define GetMsgTypeFromJsonObj(pjObj, pchMsgType) GetStringFromJson(pjObj, JSON_MSGTYPE, pchMsgType)

#define GetIsPortConfFromJsonObj(pjObj, bIsPortConf) GetStringAsBoolFromJson(pjRoot, JSON_ISPORTCONF, bIsPortConf);
...
static BOOL32 GetConfE164FromJson(const json_t_ptr& pjRoot, s8 * pchConfE164, u32 dwConfE164Len)
{
	...
	if (FALSE == GetConfE164FromJsonObj(pjRoot, &pchE164))
	{
	...
	strncpy(pchConfE164, pchE164, dwLen);
	return TRUE;
}
...
{
	const s8* pchTempPassword = NULL;
	if (FALSE == GetConfPasswordFromJsonObj(pjRoot, &pchTempPassword))
	{
		OspPrintf(TRUE, FALSE, "[GetConfNameFromJson] json_object_get ConfName is NULL, retur FALSE!\n");
		return FALSE;
	}
	...
	strncpy(pchPassword, pchTempPassword, dwLen);
	return TRUE;
}

static BOOL32 GetConfNameFromJson(const json_t_ptr& pjRoot, s8 * pchConfName, u32 dwConfNameLen)
{
	const s8* pchName = NULL;
	if (FALSE == GetConfNameFromJsonObj(pjRoot, &pchName))
	{
		OspPrintf(TRUE, FALSE, "[GetConfNameFromJson] json_object_get ConfName is NULL, retur FALSE!\n");
		return FALSE;
	}

	u32 dwLen = MAXLEN_CONFNAME >= dwConfNameLen ? dwConfNameLen : MAXLEN_CONFNAME;
	strncpy(pchConfName, pchName, dwLen);
	return TRUE;
}
...
static BOOL32 GetMoIdListFromJson(const s8 * pchJsonBuf, s8 **pachMoid )
{
	...
	for ( wMoidIdx = 0; wMoidIdx < wMoidNum; wMoidIdx++ )
	{
		...
		strncpy( pachMoid[wMoidIdx], json_string_value(pjMoidInfo), OPERATION_MAXLEN_APMOID );
	}
...
static BOOL32 GetConfInfoExFromJson(const s8 * pchJsonBuf, TConfInfoEx & tConfInfoEx )
{
	...
	*/
	...
	if ( NULL != pjSecVideoFormatArray )
	{
		...
		wSecVideoFromatNum = wSecVideoFromatNum <= MAX_CONF_CAP_EX_NUM ? wSecVideoFromatNum : MAX_CONF_CAP_EX_NUM;
		...
		for ( wSecVideoFormatIdx = 0; wSecVideoFormatIdx < wSecVideoFromatNum; wSecVideoFormatIdx++ )
		{
			...
			if ( NULL != pjMediaType )
			{
				atDoubleStreamCap[wSecVideoFormatIdx].SetMediaType(  (u8)atoi( json_string_value( pjMediaType ) )  );
			}
			...
			if ( NULL != pjMediaFrame )
			{
				if( MEDIA_TYPE_H264 == atDoubleStreamCap[wSecVideoFormatIdx].GetMediaType() || 
					MEDIA_TYPE_H265 == atDoubleStreamCap[wSecVideoFormatIdx].GetMediaType())
				{
	...
	if ( NULL != pjVideoFormatArray )
	{
		...
		wVideoFromatNum = wVideoFromatNum <= MAX_CONF_CAP_EX_NUM ? wVideoFromatNum : MAX_CONF_CAP_EX_NUM;
		...
		for ( wVideoFormatIdx = 0; wVideoFormatIdx < wVideoFromatNum; wVideoFormatIdx++ )
		{
			...
			if ( NULL != pjMediaType )
			{
				atMainStreamCap[wVideoFormatIdx].SetMediaType( (u8)atoi( json_string_value( pjMediaType ) ) );
			}
			...
			if ( NULL != pjMediaFrame )
			{
				if( MEDIA_TYPE_H264 == atMainStreamCap[wVideoFormatIdx].GetMediaType() ||
					MEDIA_TYPE_H265 == atMainStreamCap[wVideoFormatIdx].GetMediaType())
				{
	...
	//传统会议是否预占MS资源
	json_t_ptr pjPreApplyMS = json_object_get_s(pjRoot, JSON_PREAPPLYMS);
	if (pjPreApplyMS == NULL)
	{
		tConfInfoEx.SetPreApplyMS(1);
	}
	else
	{
		tConfInfoEx.SetPreApplyMS(strtoul(json_string_value(pjPreApplyMS), 0, 10));
	}	
	...
	else
	{
		...
		{	
			...
			for ( byHduParamLoop = 0; byHduParamLoop < byHduParamNum; byHduParamLoop++ )
			{
				...
				//方案索引
				json_t_ptr pjHduScheIdx = json_object_get_s( pjHduParamObj, JSON_HDUSCHEDIDX );
				if ( NULL == pjHduScheIdx )
				{
					OspPrintf( TRUE, FALSE, "[GetHduModuleFromJson] json_object_get Idx.%d pjHduScheIdx is NUll!\n", byHduParamLoop );
				}
				else
				{
					atHduChnInfo[byValidIdx].m_byScheIdx = (u8)atoi(json_string_value( pjHduScheIdx ) );
				}
				...
				else
				{
					...
					else if ( HDUCHN_MODE_ONE == atHduChnInfo[byValidIdx].m_byVmpStyle )
					{
						...
						if ( NULL == pjHduIndex )
						{
							LogPrint( LOG_LVL_ERROR, MID_MCU_MAUSSN,  "[GetHduModuleFromJson] json_object_get VmpType is NUll!\n" );
						}
						else
						{
							atHduChnInfo[byValidIdx].m_abyTvWallMember[bySubChnIdx] = (u8)atoi(json_string_value( pjHduIndex ) );
						...
						{
							atHduChnInfo[byValidIdx].m_abyHduMemChnIdx[bySubChnIdx] = 0;//界面没有给该参数，故默认 0
							LogPrint( LOG_LVL_ERROR, MID_MCU_MAUSSN,  "[GetHduModuleFromJson] json_object_get HduMtChnid is NUll!\n" );
						}
						else
						{
				...
				byValidIdx++;
				//单通道轮询数据
				// 				BOOL32 bHduPool = FALSE; 
				// 				json_t_ptr pjHduPoll = json_object_get_s( pjHduParamObj, JSON_HDUPOLL );
				// 				if ( NULL == pjHduPoll )
				// 				{
				// 					OspPrintf( TRUE, FALSE, "[GetHduModuleFromJson] json_object_get  pjHduPoll is NUll!\n" );
				// 				}
				// 				else
				// 				{
				// 					bHduPool = (u8)atoi(json_string_value( pjHduPoll ) ) ? TRUE : FALSE;
				// 				}
				// 				if (bHduPool)//hdupoll参数是否生效，0不生效 1生效
				// 				{
				// 					json_t_ptr pjHduPollNum = json_object_get_s( pjHduParamObj, JSON_HDUPOLLNUM );//轮询次数
				// 					if ( NULL == pjHduPollNum )
				// 					{
				// 						OspPrintf( TRUE, FALSE, "[GetHduModuleFromJson] json_object_get  pjHduPollNum is NUll!\n" );
				// 					}
				// 					else
				// 					{
				// 						u8 byHduPollNum = (u8)atoi(json_string_value( pjHduPollNum ) );
				// 					}
				// 
				// 					json_t_ptr pjHduKeepTime = json_object_get_s( pjHduParamObj, JSON_HDUPOLLTIME );
				// 					if ( NULL == pjHduKeepTime )
				// 					{
				// 						OspPrintf( TRUE, FALSE, "[GetHduModuleFromJson] json_object_get  pjHduKeepTime is NUll!\n" );
				// 					}
				// 					else
				// 					{
				// 						u8 byHduPollNum = (u8)atoi(json_string_value( pjHduKeepTime ) );
				// 					}
				// 
				// 					json_t_ptr pjHdupollMode = json_object_get_s( pjHduParamObj, JSON_HDUPOLLMODE );
				// 					if ( NULL == pjHdupollMode )
				// 					{
				// 						OspPrintf( TRUE, FALSE, "[GetHduModuleFromJson] json_object_get  pjHdupollMode is NUll!\n" );
				// 					}
				// 					else
				// 					{
				// 						u8 byHduPollNum = (u8)atoi(json_string_value( pjHdupollMode ) );
				// 					}
				// 				}
			}
		}
...
// 	u32 dwLen = MAXLEN_JSONBUF;
	...
	{
		OspPrintf( TRUE, FALSE, "[%s]json_dumps failed\n", __FUNCTION__ );
		return FALSE;
	}
	return TRUE;
}
...
2014/08/26  5.0         王也                    创建
=============================================================================*/
static void SetConfInfoExToJson(json_t_ptr& pjRoot, const TConfInfoEx& tConfInfoEx )
{
	if (!pjRoot) return;
	...
	SetBoolAsStringToJson(pjRoot, JSON_PREAPPLYMS, tConfInfoEx.IsPreApplyMS());
}

static void SetConfInfoExToJson(s8 * pchJsonBuf, u32 &dwJsonBufLen, const TConfInfoEx& tConfInfoEx)
{
	json_t_ptr pjRoot = NULL;
...
static BOOL32 SetReqHeadToJsonObj(const json_t_ptr& pjRoot, const TReqHeadInfo &tReqHeadInfo)
{
...
static json_t_ptr CreatVmpModuleSetJson( TVmpModuleInfo &tVmpModule )
{
	...
	else
	{
		...
		{
			if (tVmpModule.GetVmpParam().GetVmpMember(byChnIdx)->GetMemberType() == VMP_MEMBERTYPE_NULL)
			{
				continue;
			}
			...
			SetUIntAsStringToJson(pjVmpMtObj, JSON_VMPINDEX,
				tVmpModule.GetVmpParam().GetVmpMember(byChnIdx)->GetChnIdx());
			SetUIntAsStringToJson(pjVmpMtObj, JSON_VMPTYPE,
				tVmpModule.GetVmpParam().GetVmpMember(byChnIdx)->GetMemberType());
...
static json_t_ptr CreatVrsaliasToJson( const TVrsalias& tVrsalias)
{
	json_t_ptr pjVrsalias = json_object();
	if ( NULL == pjVrsalias)
	{
		OspPrintf( TRUE, FALSE, "[CreatVrsaliasToJson] pjVrsalias is NULL, return!\n" );
		return NULL;
	}
	
	SetUIntAsStringToJson(pjVrsalias, JSON_ALIAS_TYPE, tVrsalias.GetAliasType());
	SetStringToJson(pjVrsalias, JSON_ADDR, tVrsalias.GetAddr());
	SetStringToJson(pjVrsalias, JSON_VRSNO, tVrsalias.GetVrsNo());
	return pjVrsalias;
}

static BOOL32 SetRecordInfoToJsonObj(json_t_ptr pjRoot, const TAutorecAttrb& tRecord)
{
	...
	SetBoolAsStringToJson(pjRecordConfig, JSON_AUTOREC, tRecord.GetIsAutoRec());
	SetUIntAsStringToJson(pjRecordConfig, JSON_PUBLISH_MODE, tRecord.GetPublishMode());
	SetBoolAsStringToJson(pjRecordConfig, JSON_IS_REC_MAIN_VID, tRecord.GetIsRecMainVideo());
	SetBoolAsStringToJson(pjRecordConfig, JSON_IS_REC_DSTREAM, tRecord.GetIsRecDstream());
	//默认直播+录像模式
	SetStringToJson(pjRecordConfig, JSON_REC_MODE, "3");
	//默认不支持免登陆观看直播
	SetStringToJson(pjRecordConfig, JSON_ISANONYMOUS, "0");

	json_t_ptr pjVrsalias = CreatVrsaliasToJson(tRecord.GetVrsAlias());
	if (NULL != pjVrsalias)
	{
		json_object_set_s(pjRecordConfig, JSON_VRS_ALIAS, pjVrsalias);
	}

	json_object_set_s(pjRoot, JSON_AUTORECATTRB, pjRecordConfig);
	return TRUE;
}
...
static BOOL32 SetRecordInfoToJson(s8* pchJsonBuf, u32 dwJsonBufLen, const TAutorecAttrb& tRecord)
{
	json_t_ptr pjRoot = NULL;
	ReturnIfFailed(LoadJson(pchJsonBuf, dwJsonBufLen, pjRoot, TRUE));
...
static BOOL32 GetConfInfoFromJson(json_t_ptr pjRoot, TConfInfo &tConfInfo)
{
	...
	//  [4/5/2017 zhoutong] 终端双向认证（国密）
	json_t_ptr pjEncryptAuth = json_object_get_s(pjRoot, JSON_ENCRYPTAUTH);
	if (NULL == pjEncryptAuth)
	{
		OspPrintf(TRUE, FALSE, "[GetConfInfoFromJson] json_object_get pjEncryptAuth is NULL!\n");
	}
	else
	{
		tMediaEncrypt.SetEncryptAuth((u8)atoi(json_string_value(pjEncryptAuth)));
		tConfInfo.SetMediaKey(tMediaEncrypt);
	}
	...
	// 混音模式由模板决定，不能开会就赋值混音模式 [12/26/2016 wangshengke]
	//混音模式
...
// 	}
	...
	{
		// 设置最大入会终端数量
		tConfAttrb.SetMaxJoinedMtNum((u8)strtoul(json_string_value(pjMaxJoinedMt), 0, 10 ));
	}
	else
	{
		// 没有则默认设置为192
	...
	json_t_ptr pjReleaseMode = json_object_get_s(pjRoot, JSON_AUTOCLOSE);
	if (pjReleaseMode == NULL)
	{
		tConfAttrb.SetReleaseMode(CONF_RELEASEMODE_NOMT);
	}
	else
	{
		tConfAttrb.SetReleaseMode(strtoul(json_string_value(pjReleaseMode), 0, 10) != 0);
	}
	tConfAttrb.SetIsOccupyVPU(TRUE);
	tConfAttrb.SetOccupyVpuType(TConfAttrb::em_Occupy_16);

	//会议等级
    json_t_ptr pjConfLevel = json_object_get_s(pjRoot, JSON_CONFLEVEL);
	if (pjConfLevel == NULL)
	{
		tConfAttrb.SetConfLevel(0);
	}
	else
	{
		tConfAttrb.SetConfLevel((u8)strtoul(json_string_value(pjConfLevel), 0, 10));
	}
...
static BOOL32 GetVipMtListFromJson(json_t_ptr pjRoot, u8 * atVipIdx, u16& wVipNum)
{
	...
	wVipNum = json_array_size(pjVipMtArray);
	u16 wMtIdx = 0;
	for (wMtIdx = 0; wMtIdx < wVipNum; wMtIdx++)
	{
